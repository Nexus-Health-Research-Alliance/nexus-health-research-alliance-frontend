...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./presentations/pages/who-we-are/who-we-are').then(m => m.WhoWeAre)
  },
  {
    path: 'what-we-do',
    title: 'What We Do - Nexus Health Research Alliance',
    loadComponent: () => import('./presentations/pages/what-we-do/what-we-do').then(m => m.WhatWeDo)
  },
  {
    path: 'projects',
  ...
  },
  {
    ...
    loadComponent: () => import('./presentations/pages/contact-us/contact-us').then(m => m.ContactUs)
  },
  {
    path: '**',
    title: 'Page Not Found - Nexus Health Research Alliance',
    loadComponent: () => import('./presentations/pages/not-found/not-found').then(m => m.NotFound)
  }
]
